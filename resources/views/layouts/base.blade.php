                            ...
                            @if(\Illuminate\Support\Facades\Route::has('login'))
                                @auth()
                                    @if(\Illuminate\Support\Facades\Auth::user()->utype === 'ADM')
                                        <li class="menu-item menu-item-has-children parent" >
                                            <a title="User Account" href="#">My Account({{\Illuminate\Support\Facades\Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                            <ul class="submenu curency" >
                                                <li class="menu-item" >
                                                ...
                                                <li class="menu-item" >
                                                    <a title="My Orders" href="{{route('admin.profile')}}">Your Profile</a>
                                                </li>
                                                ...
                                                <li class="menu-item" >
                                                    <a title="Log Out" href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Log Out</a>
                                                </li>
                                    ...
                                    @else
                                        <li class="menu-item menu-item-has-children parent" >
                                            ...
                                            <ul class="submenu curency" >
                                                ...
                                                <li class="menu-item" >
                                                    <a title="My Orders" href="{{route('user.profile')}}">Your Profile</a>
                                                </li>
