                    ...
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                ...
                                @error('s_provine') <span class="text-danger">{{$message}}</span> @enderror
                            </p>
                            <p class="row-in-form">
                                <label for="city">Town / City<span>*</span></label>
                ...
                <div class="summary-item payment-method">
                    ...
                    <div class="choose-payment-methods">
                        <label class="payment-method">
                            ...
                            <span class="payment-desc">Pay after delivery</span>
                        </label>
                        <label class="payment-method">
                    ...
                    @if(\Illuminate\Support\Facades\Session::has('checkout'))
                        <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">{{\Illuminate\Support\Facades\Session::get('checkout')['total']}}</span></p>
                    @endif
