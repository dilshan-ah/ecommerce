                    ...
                    <div class="detail-info">
                        <div class="product-rating">
                            ...
                            @if($product->orderItems->where('rstatus',1)->count() > 0)
                                @for($i=1;$i<=5;$i++)
                                    @if($i<=$avgrating/$product->orderItems->where('rstatus',1)->count())
                        ...
                        <div class="wrap-butons">
                            ...
                            <div class="wrap-btn">
                                ...
                                @if($witems->contains($product->id))
                                    ...
                                    <a href="#" class="btn btn-wishlist" style="color: red" wire:click.prevent="removeFromWishlist({{$product->id}},'{{$product->name}}',{{$product->regular_price}})">Added in Wishlist</a>
                                @else
                                                ...
                                                <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                                    <div id="comment-20" class="comment_container">
                                                        @if($orderItem->order->user->profile->image)
                                                            <img alt="" src="{{asset('assets/images/profile')}}/{{$orderItem->order->user->profile->image}}" height="80px" width="80px">
                                                        @else
                                                            <img alt="{{$orderItem->order->user->name}}" src="{{asset('assets/images/profile/OIP.jpg')}}" height="80" width="80">
                                                        @endif
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">{{$p_products->price}}</span></div>
                                    </div>
                                </div>
                            </li>
                            @endforeach
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            ...
                            <div class="product product-style-2 equal-elem ">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="wrap-price"><span class="product-price">{{$r_products->price}}</span></div>
                                </div>
                            </div>
                            @endforeach
                        </div>
