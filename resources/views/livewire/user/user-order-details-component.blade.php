                    ...
                    <table class="table">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{route('user.orders')}}" style="margin-right: 10px;" class="btn btn-success pull-right">My Orders</a>
                                    ...
                                    @foreach($order->orderItems as $item)
                                        <li class="pr-cart-item">
                                            ...
                                            @elseif($item->rstatus == true)
                                                <div class="price-field sub-total"><p class="price">Reviewed</p></div>
                                            @endif
                                        </li>
                                    @endforeach
                                </ul>
